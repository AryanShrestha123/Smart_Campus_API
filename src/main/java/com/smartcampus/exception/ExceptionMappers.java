...
public class ExceptionMappers {
    ...
    // RoomId reference does not exist
    @Provider
    ...
    // Sensor is in MAINTENANCE or OFFLINE
    @Provider
    ...
    // Global Safety Net: Catches all unexpected Throwables
    @Provider
    public static class GlobalExceptionMapper
        ...
        public Response toResponse(Throwable e) {
            LOGGER.log(Level.SEVERE, "Unhandled exception caught by GlobalExceptionMapper", e);
            Map<String, Object> body = new LinkedHashMap<>();
            body.put("status",  500);
